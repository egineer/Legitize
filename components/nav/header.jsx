...
const Header = ({web3Handler,account})=>{
  ...
  if(status==="unauthenticated"){
      userProfileDropdown = (
        <>
        <Link href={'/auth/login'} className="flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600">
        <svg
        ...
        <Link href={'/auth/register'} className="flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
          ...
          <span className="mt-1 font-display text-sm text-jacarta-700 dark:text-white">Sign Up</span>
        </Link>
      </>
      )
  }
    ...
    (
      <>
        ...
        <Link href={'/panel/logout'} className="flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
      ...
      <div className="flex items-center px-6 py-6 xl:px-24">
        ...
        >
          ...
          <nav className="navbar w-full">
            ...
            <li className="group">
                <Link href={'/'} className="flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent focus:text-accent dark:text-white dark:hover:text-accent dark:focus:text-accent lg:px-5">
                Home
                </Link>
              </li>
              <li className="group">
                <Link href={'/collections'} className="flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent focus:text-accent dark:text-white dark:hover:text-accent dark:focus:text-accent lg:px-5">
                  Collections
                </Link>
              </li>
              <li className="js-nav-dropdown nav-item dropdown group relative">
                ...
                >
                  <li>
                    <Link href={'/assets/'} className="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600">
                    ...
                    categories.map((cat,catIndex)=>{
                      return(
                        ...
                        <span className="mr-3 rounded-xl bg-[#E4FCF4] p-[0.375rem]" dangerouslySetInnerHTML={{__html: cat.image}}>
                          ...
                          <span className="font-display text-sm text-jacarta-700 dark:text-white">{cat.name}</span>
                        </Link>
                      </li>
                      )
                    })
                ...
                >
                  ...
                  <li>
                    <a
                      ...
                      className="flex items-center rounded-xl px-5 py-2 transition-colors hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                    >
                      <span className="font-display text-sm text-jacarta-700 dark:text-white">Learn about NFT</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li className="group">
                <Link href={'/panel/assets/create'} className="flex items-center justify-between py-3.5 font-display text-base text-jacarta-700 hover:text-accent focus:text-accent dark:text-white dark:hover:text-accent dark:focus:text-accent lg:px-5">
                List An Asset
                </Link>
              </li>
            </ul>
