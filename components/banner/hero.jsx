const HeroBanner = ()=>{
    ...
    return(
        <section class="hero relative py-10 md:pt-32">
        ...
        <div class="container">
          <div class="mx-auto max-w-2xl pt-24 text-center">
            <h1 class="mb-10 font-display text-5xl text-jacarta-700 dark:text-white lg:text-6xl xl:text-7xl">
              Welcome to Legitize, where <span class="animate-gradient">NFTs</span> have <br/>
              <span class="animate-gradient"> Real Meterial Values</span>
            </h1>
            {/* <!-- Search --> */}
            ...
            <span class="dark:text-jacarta-300">Example searches: </span>
            <a href="#" class="text-accent hover:text-jacarta-700 dark:hover:text-white">Rolex watch</a><span>,</span>
            <a href="#" class="text-accent hover:text-jacarta-700 dark:hover:text-white">Real Estate in Turkey</a
            ><span>,</span>
            <a href="#" class="text-accent hover:text-jacarta-700 dark:hover:text-white">Artworks</a>
          </div>
        </div>
      </section>
    )
