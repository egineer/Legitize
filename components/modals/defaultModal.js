const DefautModal = ({ show, onClose }) => {
  return (
    <div
      class="modal fade"
      id="levelsModal"
      ...
      <div class="modal-dialog max-w-2xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="addLevelsLabel">
              Add levels
            </h5>
            <button
              type="button"
          ...
          <div class="modal-body p-6">
            ...
            <div class="relative my-3 flex items-center">
              <button class="flex h-12 w-12 shrink-0 items-center justify-center self-end rounded-l-lg border border-r-0 border-jacarta-100 bg-jacarta-50 hover:bg-jacarta-100 dark:border-jacarta-600 dark:bg-jacarta-700">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <div class="flex w-1/2 items-end">
                ...
                <div class="flex h-12 w-12 items-center justify-center self-end border-y border-jacarta-100 bg-jacarta-50 px-2 dark:border-jacarta-600 dark:bg-jacarta-800 dark:text-jacarta-400">
                  Of
                </div>
            ...
            <button class="mt-2 rounded-full border-2 border-accent py-2 px-8 text-center text-sm font-semibold text-accent transition-all hover:bg-accent hover:text-white">
              Add More
            </button>
          </div>
